...
import frc.team1816.states.IntakeState;
import frc.team1816.states.SuperstructureCommand;
import frc.team1816.states.SuperstructureConstants;
import frc.team1816.states.SuperstructureState;
...
public class Superstructure extends Subsystem {
    ...
    private ISolenoid mUnlockHookSolenoid = Constants.makeSolenoidForId(Constants.kUnlockHookSolenoid);
    private ISolenoid mJazzHandsSolenoid = Constants.makeSolenoidForId(Constants.kJazzHandsSolenoid);
    private ISolenoid mKickstandSolenoid = Constants.makeSolenoidForId(Constants.kKickstandSolenoid);
