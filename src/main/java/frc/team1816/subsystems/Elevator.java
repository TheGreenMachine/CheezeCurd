...
public class Elevator extends Subsystem {
    ...
    private final IMotorControllerEnhanced mMaster, mRightSlave, mLeftSlaveA, mLeftSlaveB;
    private final ISolenoid mShifter;
    ...
    public synchronized void readPeriodicInputs() {
        ...
        mPeriodicIO.limit_switch = ((TalonSRX)mMaster).getSensorCollection().isFwdLimitSwitchClosed();
        mPeriodicIO.t = t;
