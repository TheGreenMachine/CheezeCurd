...
import com.team254.lib.drivers.GhostSolenoid;
...
public class Constants {
    ...
    // Intake
    public static final int kIntakeLeftMasterId = -1;
    public static final int kIntakeRightMasterId = -1;
    public static final int kCanifierId = 12;
    public static final int kPigeon = 13;

    // Elevator
    public static final int kElevatorMasterId = -1;
    public static final int kElevatorRightSlaveId = -1;
    public static final int kElevatorLeftSlaveAId = -1;
    public static final int kElevatorLeftSlaveBId = -1;

    // Wrist
    public static final int KWristMasterId = -1;

    // Solenoids
    public static final int kShifterSolenoidId = -1; // PCM 0, Solenoid 4
    public static final int kIntakeCloseSolenoid = -1;
    public static final int kIntakeClampSolenoid = -1;
    public static final int kForkliftDeploySolenoid = -1;  // CURRENTLY 6 ON PRACTICE!!!
    public static final int kFollowerWheelSolenoid = -1;
    public static final int kElevatorShifterSolenoidId = -1;
    public static final int kUnlockHookSolenoid = -1;
    public static final int kJazzHandsSolenoid = -1;
    public static final int kKickstandSolenoid = -1;
     ...
     */
    public static ISolenoid makeSolenoidForId(int solenoidId) {
        if(solenoidId < 0) return new GhostSolenoid();
        if (solenoidId <= 4) {
            // These solenoids are on PCM 1, wired 1-4 to 7-4.
            return new LazySolenoid(1, 8 - solenoidId);
        } else if (solenoidId <= 8) {
            // These solenoids are on PCM 0, wired 5-8 to 0-3.
            return new LazySolenoid(0, solenoidId - 5);
        } else if (solenoidId <= 12) {
            // These solenoids are on PCM 0, wired 9-12 to 7-4.
            return new LazySolenoid(0, 16 - solenoidId);
        }
